...
public interface DfLReverseExistingFileInfo {
    ...
    /**
     * @return The map of existing file's on-file table names. (NotNull)
     */
    Map<File, List<String>> getExistingFileTableListMap();

    /**
     * @return The map of on-file table name's all existing files. (NotNull)
     */
    Map<String, List<File>> getTableAllExistingFileListMap();

    /**
     * @return The map of on-file table name's first existing files. (NotNull)
     */
