...
import org.dbflute.logic.generate.language.grammar.DfLanguageGrammarScala;
import org.dbflute.logic.generate.language.implstyle.DfLanguageImplStyle;
import org.dbflute.logic.generate.language.implstyle.DfLanguageImplStyleScala;
import org.dbflute.logic.generate.language.pkgstyle.DfLanguagePropertyPackageResolver;
import org.dbflute.logic.generate.language.pkgstyle.DfLanguagePropertyPackageResolverScala;
...
public class DfLanguageDependencyScala extends DfLanguageDependencyJava {
    ...
    public String getESFluteFreeGenControl() {
        return "om/scala/plugin/esflute/ControlFreeGenEsScala.vm";
    }

    @Override
    public String getLastaFluteFreeGenControl() {
        return "om/scala/plugin/lastaflute/ControlFreeGenLastaScala.vm";
    }
