...
import org.dbflute.logic.generate.language.framework.DfLanguageFrameworkJava;
import org.dbflute.logic.generate.language.grammar.DfLanguageGrammar;
import org.dbflute.logic.generate.language.grammar.DfLanguageGrammarJava;
import org.dbflute.logic.generate.language.implstyle.DfLanguageImplStyle;
import org.dbflute.logic.generate.language.implstyle.DfLanguageImplStyleJava;
import org.dbflute.logic.generate.language.pkgstyle.DfLanguageClassPackage;
import org.dbflute.logic.generate.language.pkgstyle.DfLanguageClassPackageJava;
import org.dbflute.logic.generate.language.pkgstyle.DfLanguagePropertyPackageResolver;
import org.dbflute.logic.generate.language.pkgstyle.DfLanguagePropertyPackageResolverJava;
import org.dbflute.logic.generate.language.typemapping.DfLanguageTypeMapping;
import org.dbflute.logic.generate.language.typemapping.DfLanguageTypeMappingJava;
...
public class DfLanguageDependencyJava implements DfLanguageDependency {
    ...
    public String getESFluteFreeGenControl() {
        return "om/java/plugin/esflute/ControlFreeGenEsJava.vm";
    }

    public String getLastaFluteFreeGenControl() {
        return "om/java/plugin/lastaflute/ControlFreeGenLastaJava.vm";
    }
    ...
    public String getResourceOutputDirectory() {
        return DfEngineWorkDir.toPath("../resources");
    }
