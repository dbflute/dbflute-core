 ...
 */
public class ManageEngineLicenseTest extends EngineTestCase {

    private static final String COPYRIGHT = "Copyright 2014-2024 the original author or authors.";
