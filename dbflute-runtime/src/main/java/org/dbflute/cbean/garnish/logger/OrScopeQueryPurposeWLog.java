 ...
 */
public class OrScopeQueryPurposeWLog {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(OrScopeQueryPurposeWLog.class);
    ...
    public static boolean isLogEnabled() { // very internal
        ...
        if (_warningLogLevelInfo) {
            ...
            // #for_now jflute not support debug, because the warnings almost don't work when debug (local environment only) (2023/07/19)
