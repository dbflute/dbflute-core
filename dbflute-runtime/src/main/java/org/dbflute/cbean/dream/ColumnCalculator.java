...
public interface ColumnCalculator {
     ...
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      op.<span style="color: #CC4747">plus</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  });
     * 
     * e.g. ColumnQuery: ... &gt; PURCHASE_PRICE + PURCHASE_COUNT
     *  cb.columnQuery(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      cb.column...();
     *  }).greaterThan(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      cb.columnPurchasePrice();
     *  }).<span style="color: #CC4747">plus</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     * e.g. ManualOrder: order by PURCHASE_PRICE - PURCHASE_COUNT
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      op.<span style="color: #CC4747">minus</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  });
     * 
     * e.g. ColumnQuery: ... &gt; PURCHASE_PRICE - PURCHASE_COUNT
     *  cb.columnQuery(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     *  }).greaterThan(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      cb.columnPurchasePrice();
     *  }).<span style="color: #CC4747">minus</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     * e.g. ManualOrder: order by PURCHASE_PRICE * PURCHASE_COUNT
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      op.<span style="color: #CC4747">multiply</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  });
     * 
     * e.g. ColumnQuery: ... &gt; PURCHASE_PRICE * PURCHASE_COUNT
     *  cb.columnQuery(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     *  }).greaterThan(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      cb.columnPurchasePrice();
     *  }).<span style="color: #CC4747">multiply</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     * e.g. ManualOrder: order by PURCHASE_PRICE / PURCHASE_COUNT
     *  cb.query().addOrderBy_PurchasePrice_Asc().withManualOrder(op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      op.<span style="color: #CC4747">divide</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     *  });
     * 
     * e.g. ColumnQuery: ... &gt; PURCHASE_PRICE / PURCHASE_COUNT
     *  cb.columnQuery(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     *  }).greaterThan(colCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *      cb.columnPurchasePrice();
     *  }).<span style="color: #CC4747">divide</span>(cb.<span style="color: #994747">dreamCruiseCB()</span>.specify().columnPurchaseCount());
     * </pre>
     ...
     * <pre>
     * ...).<span style="color: #CC4747">convert</span>(op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.addDay(8).truncTime());
     * </pre>
