...
public class ConditionBeanContext {
    ...
    public static void loadCoolClasses() {
        ...
        {
            loadClass(org.dbflute.AccessContext.class);
            loadClass(org.dbflute.CallbackContext.class);
            loadClass(org.dbflute.cbean.EntityRowHandler.class);
            loadClass(org.dbflute.cbean.coption.FromToOption.class);
            loadClass(org.dbflute.cbean.coption.LikeSearchOption.class);
            loadClass(org.dbflute.cbean.grouping.GroupingOption.class);
            loadClass(org.dbflute.cbean.grouping.GroupingRowEndDeterminer.class);
            loadClass(org.dbflute.cbean.grouping.GroupingRowResource.class);
            loadClass(org.dbflute.cbean.grouping.GroupingRowSetupper.class);
            loadClass(org.dbflute.cbean.pagenavi.PageNumberLink.class);
            loadClass(org.dbflute.cbean.pagenavi.PageNumberLinkSetupper.class);
