...
public class MelodicSqlAnalyzerFactory implements SqlAnalyzerFactory {
    ...
    public SqlAnalyzer create(String sql, boolean blockNullParameter) {
        return newMelodicSqlAnalyzer(sql, blockNullParameter);
    }

    protected MelodicSqlAnalyzer newMelodicSqlAnalyzer(String sql, boolean blockNullParameter) {
        return new MelodicSqlAnalyzer(sql, blockNullParameter);
    }
}
